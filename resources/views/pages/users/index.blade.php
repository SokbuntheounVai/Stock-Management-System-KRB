...
@section('content')
@if(Session::has('u-success'))
<p id="ms-success" style="display: none">{{session('u-success')}}</p>
<script>
...
@endif
@if(Session::has('u-error'))
<p id="ms-error" style="display: none">{{session('u-error')}}</p>
<script>
...
@endif
@if(Session::has('d-success'))
<p id="ms-success" style="display: none">{{session('d-success')}}</p>
<script>
    var ms = document.getElementById('ms-success').innerHTML;
    Swal.fire(
        'Deleted!',
...
@endif
@if(Session::has('d-error'))
<p id="ms-error" style="display: none">{{session('d-error')}}</p>
<script>
    var ms = document.getElementById('ms-error').value;
    Swal.fire({
        type: 'error',
